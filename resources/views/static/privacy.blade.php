    ...
    <div class="container">
      <div class="privacy__content">
        ...
        <p class="privacy__subtext">
          ...
          отношении всей информации, которую сайт <b>Просто Ремонт (студия дизайна и ремонта в Белореченске)</b>,
          (далее – Просто Ремонт) расположенный на доменном имени <b>prostoremont.ru</b>, может получить о
          Пользователе во время использования сайта prostoremont.ru, его программ и его продуктов.
        </p>
        <div class="privacy__chapter">
          ...
          <div class="privacy__chapter-text">
            ...
            <p>
              ...
              Просто Ремонт (студия дизайна и ремонта в Белореченске), действующие от имени ООО "КУБАНЬ А СТРОЙ",
              которые
            ...
            <p>
              1.1.5. «Сайт Просто Ремонт (студия дизайна и ремонта в Белореченске)» - это совокупность связанных между
              собой веб-страниц, размещенных в сети Интернет по уникальному адресу (URL): prostoremont.ru.
            </p>
            <p>
              1.1.6. «Пользователь сайта Просто Ремонт (студия дизайна и ремонта в Белореченске)» (далее Пользователь) –
              лицо, имеющее доступ к сайту Просто Ремонт (студия дизайна и ремонта в Белореченске), посредством сети
              Интернет и использующее информацию, материалы и продукты сайта Просто Ремонт (студия дизайна и ремонта в
              Белореченске).
            </p>
            <p>
        ...
        <div class="privacy__chapter">
          ...
          <div class="privacy__chapter-text">
            <p>
              2.1. Использование сайта Просто Ремонт Пользователем означает согласие
            ...
            <p>
              ...
              использование сайта Просто Ремонт.
            </p>
            <p>
              2.3. Настоящая Политика конфиденциальности применяется к сайту Просто Ремонт (студия дизайна и ремонта в
              Белореченске). Просто Ремонт не контролирует и не несет ответственность за сайты третьих лиц, на
              которые Пользователь может перейти по ссылкам, доступным на сайте Просто Ремонт.
            </p>
            <p>
        ...
        <div class="privacy__chapter">
          ...
          <div class="privacy__chapter-text">
            <p>
              ...
              запросу Администрации при регистрации на сайте Просто Ремонт (студия дизайна и ремонта в Белореченске),
            ...
            <p>
              ...
              предоставляются Пользователем путём заполнения форм на сайте Просто Ремонт и включают в
            ...
            <p>
              3.3.2. Просто Ремонт осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
          ...
          <div class="privacy__chapter-text">
            ...
            <div class="privacy__chapter-list">
              ...
              <p>
                ...
                связанных с использованием сайта Просто Ремонт.
              </p>
              <p>
                4.1.9. Предоставления Пользователю с его согласия специальных предложений, информации о ценах, новостной
                рассылки и иных сведений от имени сайта Просто Ремонт (студия дизайна и ремонта в Белореченске).
              </p>
              <p>
