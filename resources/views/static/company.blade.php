  ...
  <section class="company indent--big indent--breadcrumbs">
    <div class="container">
      ...
      <h1 class="company__title">
        <span>Просто Ремонт</span> – дизайн-студия и <br> ремонтно-отделочная компания <br> в Белореченске
      </h1>
      <div class="company__text">
        <p>
          Компания «Просто Ремонт» основана в 2013 году. Мы строим ремонтируем и создаем
