@include('fragments.head', ['title' => 'Создание статьи'])
  ...
  <section class="articles indent--big indent--breadcrumbs">
    <div class="container">
      <ul class="breadcrumbs">
        ...
        <li class="breadcrumbs__item">
          <span class="breadcrumbs__link active">Создание статьи</span>
        </li>
      </ul>
      <h1 class="articles__title title">Создание статьи</h1>
      <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="articles__step">
          ...
          <div class="articles__inner">
            <img class="articles__img" id="image-preview" src="#" alt="">
          </div>
        </div>
        <div class="articles__step">
        ...
        <div>
          <button class="articles__create btn" type="submit">Создать статью</button>
        </div>
      </form>
    </div>
  </section>
