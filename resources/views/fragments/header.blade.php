      ...
      <div class="header__right">
        <nav class="header__nav">
          <ul class="header__list">
            <li>
              <a class="header__link" href="{{route('company')}}">О компании</a>
            </li>
            <li>
        ...
        <div class="header__phones">
          <a class="header__whatsapp" href="https://wa.me/79006764523" target="_blank">
            <svg class="header__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path fill="#fff"
          ...
          <a class="header__phone" href="tel:+79403067777">+7 940 306 77 77</a>
        </div>
      </div>
      <button class="menu-btn menu-btn--header" type="button">
        <span class="menu-btn__line"></span>
        <span class="sr-only">Interact with the menu</span>
      </button>
    </div>
  </div>
